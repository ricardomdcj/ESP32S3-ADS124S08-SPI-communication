...
#define ADS124S08_DRDY_PIN  7
#define ADS124S08_CS_PIN    6
#define ADS124S08_START_PIN 5
#define ADS124S08_PWDN_PIN  4
#define ADS124S08_DO_MISO_PIN  13
#define ADS124S08_DI_MOSI_PIN  11
#define ADS124S08_CLK_SCLK_PIN 12
...
public:
  ...
  esp_err_t setupSPI(void);
  esp_err_t ADS124S08_Init(void);
